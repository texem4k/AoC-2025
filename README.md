...
(tipically 24 but this year is to 12).
###
...
#### How it's everything organized?
You have everything organized in folders:

* **Doc** -> The documentation is in the *Doc* folder, with the problem info in spanish because I'm not going to translate everything :/    
* **src/main** -> The Production Code, the tasty things :)
